...
A collection of SQL scripts written while learning PostgreSQL and relational database concepts. Each file focuses on a specific SQL topic, including database creation, table management, CRUD operations, constraints, operators, and built-in functions.
...
Each `.sql` file is independent and can be executed separately in PostgreSQL.
...
Each SQL file is independent and can be run individually.
